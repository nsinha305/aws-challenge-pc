...
"properties" : {
"ack_id" : { "type" : "text"},
"form_plan_year_begin_date" : { "type" : "text"},
...
"plan_eff_date" : { "type" : "text"},
"sponsor_dfe_name" : { "type" : "text"},
...
"spons_dfe_mail_us_state" : { "type" : "text"},
...
"admin_signed_date" : { "type" : "text"},
"admin_signed_name" : { "type" : "text"},
"spons_signed_date" : { "type" : "text"},
"spons_signed_name" : { "type" : "text"},
"dfe_signed_date" : { "type" : "text"},
...
"admin_manual_signed_date" : { "type" : "text"},
